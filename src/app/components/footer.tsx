    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          {categories.slice(0, 6).filter((cat) => cat.canvaLink).map((cat) => {
            const title = language === "id"
              ? cat.label
              : cat.key === "buket-satin" ? "Satin Bouquet"
                : cat.key === "snack-bouquet" ? "Snack Bouquet"
                  : cat.key === "money-bouquet" ? "Money Bouquet"
                    : cat.key === "chocolate-bouquet" ? "Chocolate Bouquet"
                      : cat.key === "fresh-flower" ? "Fresh Flower"
                        : cat.key === "artificial-flower" ? "Artificial Flower"
                          : "Premium Packages";

            const description = language === "id"
              ? cat.description
              : cat.key === "buket-satin" ? "High-quality satin bouquets with curated blooms. Perfect for special moments."
                : cat.key === "snack-bouquet" ? "A unique blend of flowers and premium snacks. A meaningful and functional gift."
                  : cat.key === "money-bouquet" ? "Elegant money bouquets for special occasions. Practical and memorable."
                    : cat.key === "chocolate-bouquet" ? "Flowers paired with premium chocolate. Ideal for special gifting."
                      : cat.key === "fresh-flower" ? "Fresh flowers arranged with beautiful color combinations."
                        : cat.key === "artificial-flower" ? "Premium artificial flowers that are elegant and long-lasting."
                          : "Premium packages for special events and custom needs.";
            ...
            return (
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "8px" }}>
                  ...
                  <strong style={{ fontFamily: "'Inter', sans-serif", fontSize: "13px", color: "#1a1a1a" }}>{title}</strong>
                </div>
                <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "12px", color: "#666", margin: 0, lineHeight: 1.7 }}>
                  {description}
                </p>
              </a>
            );
