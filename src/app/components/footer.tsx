      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "48px" }}>
          ...
          {[
            {
              ...
              link: getWhatsAppLink(language === "id" ? `Halo ${config.businessName}! Saya tertarik dengan buket premium.` : `Hello ${config.businessName}! I'm interested in premium bouquets.`),
            },
            {
              emoji: "🍭",
              ...
              link: getWhatsAppLink(language === "id" ? `Halo ${config.businessName}! Saya tertarik dengan snack/money bouquet.` : `Hello ${config.businessName}! I'm interested in snack/money bouquets.`),
            },
            {
              emoji: "✨",
              ...
              link: getWhatsAppLink(language === "id" ? `Halo ${config.businessName}! Saya tertarik dengan gift & accessories.` : `Hello ${config.businessName}! I'm interested in gifts & accessories.`),
            },
          ].map((item) => (
            <a
              key={item.title}
        ...
        >
          <div>
            ...
            <span style={{ color: "#555", fontSize: "11px", textTransform: "none", letterSpacing: "0.02em" }}>{config.address}</span>
          </div>
          <div>
        ...
        <div style={{ textAlign: "center", paddingTop: "8px" }}>
          <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "9px", letterSpacing: "0.12em", textTransform: "uppercase", color: "#bbb", margin: 0 }}>
            &copy; {brandDisplayName} {config.year}. All rights reserved.
          </p>
          {config.footerText && (
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "12px", color: "#999", margin: "8px 0 0 0", lineHeight: 1.5 }}>
              {config.footerText}
            </p>
          )}
        </div>
