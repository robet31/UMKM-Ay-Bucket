    ...
    >
      <div style={{ display: "flex", flexDirection: "column", gap: "48px" }}>
        ...
        <div style={{ marginBottom: "8px" }}>
          <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "9px", letterSpacing: "0.14em", textTransform: "uppercase", color: "#999", margin: "0 0 12px 0" }}>
            ...
            {currentCategories.slice(0, 8).map((cat) => (
              <a
                ...
                style={{
                  ...
                  gap: "6px",
                  padding: "8px 14px",
                  backgroundColor: "rgba(184,92,59,0.06)",
                  border: "1px solid rgba(184,92,59,0.12)",
                  borderRadius: "999px",
                  textDecoration: "none",
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.backgroundColor = "rgba(184,92,59,0.12)";
                  e.currentTarget.style.borderColor = "rgba(184,92,59,0.3)";
                  e.currentTarget.style.color = "#b85c3b";
                  e.currentTarget.style.transform = "translateY(-1px)";
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.backgroundColor = "rgba(184,92,59,0.06)";
                  e.currentTarget.style.borderColor = "rgba(184,92,59,0.12)";
        ...
        >
          <div>
            ...
            <span style={{ color: "#555", fontSize: "11px", textTransform: "none", letterSpacing: "0.02em", whiteSpace: "pre-wrap" }}>{(config.address || "").replace(/^toko:\s*/i, "").trim() || "Ruko Jambu Raya Perumnas Kamal"}</span>
          </div>
          <div>
