...
const getCatalogLinkLabel = (type: string) => {
  switch (type) {
...
export function Contact() {
  ...
  const msg = language === "id" 
    ? "Halo Ay Bucket! Saya ingin bertanya tentang produk dan pemesanan bunga 🌸" 
    : "Hello Ay Bucket! I'd like to ask about products and flower ordering 🌸";
    ...
    <PageTransition>
      ...
      >
        <div style={{ paddingTop: "100px", maxWidth: "1280px", margin: "0 auto", width: "100%" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px", borderBottom: "2px solid #ff96ad", paddingBottom: "12px" }}>
            <motion.a
                  ...
                  <div style={{ marginBottom: "14px" }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                      <a 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer" 
                        style={{ fontFamily: "'Inter', sans-serif", fontSize: "14px", margin: 0, color: "#1a1a1a", fontWeight: 500, textDecoration: "none", transition: "color 0.2s" }}
                        onMouseEnter={(e) => e.currentTarget.style.color = "#ff96ad"}
                      ...
                      {config.whatsappNumber2 && (
                        <a 
                          ...
                          target="_blank" 
                          rel="noopener noreferrer" 
                          style={{ fontFamily: "'Inter', sans-serif", fontSize: "12px", margin: 0, color: "#666", textDecoration: "none", transition: "color 0.2s" }}
                          onMouseEnter={(e) => e.currentTarget.style.color = "#ff96ad"}
          ...
          >
            ...
            {(() => {
              const msg = "Halo Ay Bucket! Saya ingin bertanya tentang produk dan pemesanan bunga 🌸";
              const btnStyle = {
                fontFamily: "'JetBrains Mono', monospace",
                fontSize: "11px",
                letterSpacing: "0.12em",
