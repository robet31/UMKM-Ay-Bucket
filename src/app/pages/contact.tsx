        ...
        <div style={{ paddingTop: "100px", maxWidth: "1280px", margin: "0 auto", width: "100%" }}>
          ...
          <div className="contact-wa-numbers" style={{ display: "flex", flexWrap: "wrap", gap: "24px", alignItems: "center" }}>
            ...
            {config.whatsappNumber2 && (
              <motion.a
                key="wa2"
                href={`https://wa.me/${config.whatsappNumber2.replace(/[^0-9]/g, "")}`}
                target="_blank"
                rel="noopener noreferrer"
                initial={{ opacity: 0, x: -20 }}
                animate={{ opacity: 1, x: 0 }}
                ...
                >
                  <div style={{ marginBottom: "14px" }}>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ fontFamily: "'Inter', sans-serif", fontSize: "14px", margin: 0, color: "#1a1a1a", fontWeight: 500, textDecoration: "none", display: "block" }}
                    >
                      {config.whatsappDisplay}
                    </a>
                    {config.whatsappNumber2 && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        style={{ fontFamily: "'Inter', sans-serif", fontSize: "14px", marginTop: "4px", color: "#666", fontWeight: 500, textDecoration: "none", display: "block" }}
                      >
                        {config.whatsappDisplay2}
                      </a>
                    )}
